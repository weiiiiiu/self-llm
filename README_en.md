...
&emsp;&emsp;**_We hope to become the bridge between LLMs and the general public, embracing a broader and more expansive LLM world with the spirit of freedom and equality in open source._**
...
- [InternLM3](https://github.com/InternLM/InternLM)
  ...
  - [x] [internlm3-8b-instruct o1-like Reasoning Chain Implementation](./models/InternLM3/05-internlm3-8b-instruct-与o1.md) @陈睿
